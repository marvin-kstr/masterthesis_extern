#############
# Note, to generate Figure 12 or Figure 14, 
...
########## Nonlinear Function for Figure 12 ################
...
########## Nonlinear Function for Figure 14 ################
...
## Exp euler:
EEM_h_trunc1 = fig.add_subplot(121)
EEM_h_trunc1.hist(EEM_create_spatQuadVar_MC_samples(M_trunc,N_trunc1,J_trunc,MC), bins=5, density=True)
EEM_h_trunc1.plot(gaus_spat, stats.norm.pdf(gaus_spat, mu, sigma_spat))
EEM_h_trunc1.set_title('N=5000')

##Semilin repl method:
SRM_h_trunc2 = fig.add_subplot(122)
SRM_h_trunc2.hist(EEM_create_spatQuadVar_MC_samples(M_trunc,N_trunc2,J_trunc,MC), bins=5, density=True)
SRM_h_trunc2.plot(gaus_spat, stats.norm.pdf(gaus_spat, mu, sigma_spat))
SRM_h_trunc2.set_title('N=10000')
